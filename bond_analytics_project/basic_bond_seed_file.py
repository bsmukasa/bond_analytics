...
test_bond_list = [
    ...
    dict(name='test_bond_1', face_value=1000, annual_interest=27.5 * 2, annual_coupon_rate=0.055,
         annual_required_return=0.0575, issue_date=datetime.date(1978, 1, 26), settlement_date=datetime.date(2007, 1, 26),
    ...
    dict(name='test_bond_2', face_value=1000, annual_interest=37.5 * 2, annual_coupon_rate=0.075,
         annual_required_return=0.065, issue_date=datetime.date(1991, 2, 16), settlement_date=datetime.date(2007, 2, 16),
    ...
    dict(name='test_bond_4', face_value=1000, annual_interest=45.00 * 2, annual_coupon_rate=0.09,
         annual_required_return=0.0725, issue_date=datetime.date(1987, 11, 6), settlement_date=datetime.date(2006, 7, 16),
